(function () {
    ...
    var WORKS = [{
            ...
            description: 'Helped build the Mahalo 4.0 Django platform for creating and managing how-to content. Built parts of the Wiki back-end and built the web front-end client and admin app for the Mahalo.com homepage. While hired to help build out the Django back-end, quickly succumbed to a horrifying JavaScript addiction that, to this day, have yet to recover from.',
